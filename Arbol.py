...
def draw_foliage():
    ...
    quadric = gluNewQuadric()
    gluSphere(quadric, 5.0, 32, 32)  # Radio de la esfera
    glPopMatrix()

def draw_foliage():
    """Dibuja las hojas del árbol como una esfera"""
    glPushMatrix()
    glColor3f(0.5, 5, 0.2)  # Verde para las hojas
    glTranslatef(0.5, 3.5, 0.5)  # Posicionar las hojas encima del tronco
    quadric = gluNewQuadric()
    gluSphere(quadric, 1.3, 25, 25)  # Radio de la esfera
    glPopMatrix()
