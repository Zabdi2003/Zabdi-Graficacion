...
# Lista para almacenar la trayectoria de la pelotita
trajectory = []
...
while True:
    ...
    if new_ball_pos is not None:
        ...
        if a < frame_margin or a > y - frame_margin or b < frame_margin or b > x - frame_margin:
            ...
            a, b = ball_pos.ravel()
            # Limpiar la trayectoria cuando la pelota regresa al punto original
            trajectory.clear()
        ...
        # Dibujar la trayectoria de la pelotita
