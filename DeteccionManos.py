...
def reconocer_letra(hand_landmarks, frame):
    ...
    elif distancia_pulgar_indice < 30 and indice[1] < medio[1] and medio[1] > anular[1] and anular[1] > meñique[1]:
        return "D"  # Seña de la letra D (dedo índice arriba, pulgar tocando índice)
    elif pulgar[1] > indice[1] and indice[1] > medio[1] and medio[1] > anular[1] and anular[1] > meñique[1]:
        return "E"  # Seña de la letra E (todos los dedos doblados hacia la palma)
